...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		// 4. Call the hasCrossedFinishLine() method and save what is returned into a
		// variable
		boolean finish = hasCrossedFinishLine();
		// 5. If the robot has crossed the finish line...
		if (hasCrossedFinishLine()) {
			JOptionPane.showMessageDialog(null, "You have finished the race!");
		} else {
			JOptionPane.showMessageDialog(null, "Your robot has not finished the race.");
		}
